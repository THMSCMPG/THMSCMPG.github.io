...
### Determination of the Focal Length of a Thin Lens Using Multiple Experimental Methods
* **Course:** Optics
* **Skills:** Error propagation, Gaussian optics analysis, experimental comparative methodology.
...
### Precision Laser Beam Profiling: Using Optical Lenses and the Knife-Edge Method
* **Course:** Optics
...
<div class="category-card">
  <a href="{{ '/portfolio/reports/Precision Laser Beam Profiling Campagna.pdf' | relative_url }}" 
    target="_blank" rel="noopener noreferrer"
    class="btn-link">Read Full Report (PDF)</a>
</div>
...
### Mapping the Magnetic Field of a Short, Thick Solenoid
* **Course:** University Physics II
* **Skills:** Error propagation, Faraday induction, Biot-Savart Law application.
...
### Painting in Polarization: Optics Final Project
* **Course:** Optics
* **Skills:** spectral analysis, colorimetry, spectrometer to RGB conversion using Excel.
